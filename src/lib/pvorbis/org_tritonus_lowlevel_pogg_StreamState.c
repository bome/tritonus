...
(JNIEnv* env, jobject obj, jobject packet)
{
	...
	if (debug_flag) { fprintf(debug_file, "Java_org_tritonus_lowlevel_pogg_StreamState_packetIn(): end\n"); }
	return nReturn;
}
...
(JNIEnv* env, jobject obj, jobject page)
{
	...
	if (debug_flag) { fprintf(debug_file, "Java_org_tritonus_lowlevel_pogg_StreamState_pageOut(): begin\n"); }
	handle = getHandle(env, obj);
	pageHandle = getPageNativeHandle(env, page);
	nReturn = ogg_stream_pageout(handle, pageHandle);
	if (debug_flag) { fprintf(debug_file, "Java_org_tritonus_lowlevel_pogg_StreamState_pageOut(): end\n"); }
	return nReturn;
}
...
(JNIEnv* env, jobject obj, jobject page)
{
	...
	if (debug_flag) { fprintf(debug_file, "Java_org_tritonus_lowlevel_pogg_StreamState_flush(): end\n"); }
	return nReturn;
}
