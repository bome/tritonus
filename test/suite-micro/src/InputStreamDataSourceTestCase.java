/*
 *	InputStreamDataSourceTestCase.java
 */
...
{
	public InputStreamDataSourceTestCase(String strName)
	{
		super(strName);
	}
	...
	protected DataSource createDataSource()
		throws Exception
	{
		String		strContentType = "audio/x-wav";
		InputStream	inputStream = new ByteArrayInputStream(new byte[0]);
		DataSource	dataSource = new InputStreamDataSource(inputStream,
								       strContentType);
		return dataSource;
	}
	...
	{
		String		strContentType = "audio/x-wav";
		DataSource	dataSource = new InputStreamDataSource(null,
								       strContentType);
		dataSource.connect();
